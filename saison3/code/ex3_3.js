function ex_3_3(){
    ...
    if((name_1 < name_2)&&(name_2 < name_3)){
        document.getElementById("result_3_3").innerHTML = "Tout cela est classé par ordre alphabetique. ";
    }else{
        document.getElementById("result_3_3").innerHTML = "Tout cela n'est pas rangé par ordre alphabétique! ";
    }
}
